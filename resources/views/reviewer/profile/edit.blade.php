    ...
    <div class="bg-gradient-to-r from-purple-50 to-pink-50 border border-purple-200 rounded-2xl p-4 shadow-sm animate-fade-in">
        <div class="flex items-center">
            ...
            <div>
                ...
                <p class="text-xs text-purple-600 mt-0.5">{{ __('Your changes have been saved') }}</p>
            </div>
        </div>
    </div>
    @endif
                        ...
                        <div class="md:col-span-2 space-y-2">
                            ...
                            <div class="relative">
                                <textarea id="bio" name="bio" rows="4" 
                                          placeholder="{{ __('Tell us about yourself and your reviewing expertise...') }}"
