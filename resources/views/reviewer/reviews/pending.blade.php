...
@section('page-description', 'Review assignments awaiting your attention')
...
<li class="flex items-center">
    ...
    <span class="text-sm font-medium text-gray-500">Pending Reviews</span>
</li>
@endsection
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="bg-white rounded-xl shadow-lg border border-gray-100 overflow-hidden">
            <div class="px-6 py-4 bg-gradient-to-r from-yellow-50 to-amber-50 border-b border-gray-100">
                ...
                <p class="text-sm text-gray-600">Review assignments awaiting your attention</p>
            </div>
            <div class="p-6">
                    ...
                    <div class="flex items-start justify-between">
                        <div class="flex-1">
                            ...
                            <div class="flex items-center space-x-4 mb-3">
                                ...
                                <span class="text-sm text-gray-500">
                                    Deadline: {{ \Carbon\Carbon::parse($review->review_date)->format('M d, Y') }}
                                </span>
                                @endif
                            </div>
                        </div>
                ...
                <div class="text-center py-12">
                    ...
                    <p class="text-sm text-gray-400 mt-1">You'll see pending review assignments here</p>
                </div>
                @endforelse
