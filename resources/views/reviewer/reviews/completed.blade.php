...
@section('title', __('Completed Reviews'))
@section('page-title', __('Completed Reviews'))
@section('page-description', __('Reviews you have finished'))
...
<li class="flex items-center">
    ...
    <span class="text-sm font-medium text-gray-500">{{ __('Completed Reviews') }}</span>
</li>
@endsection
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="bg-white rounded-xl shadow-lg border border-gray-100 overflow-hidden">
            <div class="px-6 py-4 bg-gradient-to-r from-green-50 to-emerald-50 border-b border-gray-100">
                <h2 class="text-lg font-bold text-gray-900">{{ __('Completed Reviews') }}</h2>
                <p class="text-sm text-gray-600">{{ __('Reviews you have finished') }}</p>
            </div>
            <div class="p-6">
                        ...
                        <div class="flex-1">
                            ...
                            <div class="flex items-center space-x-4 mb-3">
                                ...
                                <span class="text-sm text-gray-500">
                                    {{ __('Completed') }}: {{ $review->updated_at?->format('M d, Y') ?? __('N/A') }}
                                </span>
                            </div>
                ...
                <div class="text-center py-12">
                    ...
                    <p class="text-gray-500 font-medium">{{ __('No completed reviews') }}</p>
                    <p class="text-sm text-gray-400 mt-1">{{ __('You will see your completed reviews here') }}</p>
                </div>
                @endforelse
