                    ...
                    <div class="space-y-1 mt-6">
                        ...
                        <div class="space-y-1 mt-4">
                            <div class="px-3 py-1 flex items-center">
                                ...
                                <h3 class="text-xs font-bold text-gray-600 uppercase tracking-wider">Reviews</h3>
                            </div>
                            <a href="{{ route('reviewer.reviews.index') }}" class="flex items-center px-3 py-2 text-gray-700 rounded-lg hover:bg-gradient-to-r hover:from-purple-50 hover:to-pink-50 hover:text-purple-700 transition-all duration-300 group btn-modern border border-transparent hover:border-purple-100 hover:shadow-md">
                                ...
                                <span class="font-medium text-sm">All Reviews</span>
                            ...
                            <a href="{{ route('reviewer.reviews.pending') }}" class="flex items-center px-3 py-2 text-gray-700 rounded-lg hover:bg-gradient-to-r hover:from-yellow-50 hover:to-amber-50 hover:text-yellow-700 transition-all duration-300 group btn-modern border border-transparent hover:border-yellow-100 hover:shadow-md">
                                ...
                                <span class="font-medium text-sm">Pending Reviews</span>
                ...
                <div class="flex items-center justify-between px-4 py-3 sm:px-6 lg:px-8">
                    ...
                    <div class="flex-1 min-w-0 lg:ml-0">
                        ...
                        <p class="mt-1 text-xs text-gray-600 font-medium">
                            @yield('page-description', 'Welcome to your Reviewer portal')
                        </p>
                    </div>
                    ...
                    <div class="flex items-center space-x-2">
                        ...
                        <div class="relative group">
                            <select class="appearance-none bg-gradient-to-r from-white to-gray-50 border border-gray-200 rounded-xl px-4 py-2.5 pr-10 text-sm font-semibold text-gray-800 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-purple-500 transition-all duration-300 hover:border-purple-300 hover:shadow-md hover:shadow-purple-100 cursor-pointer min-w-[140px]">
                            ...
                            <div class="absolute inset-0 rounded-xl bg-gradient-to-r from-transparent via-transparent to-purple-50/30 pointer-events-none opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                        </div>
                        ...
                        <div class="relative z-[9999]">
                            <button id="headerUserMenu" class="flex items-center space-x-2 p-1.5 text-sm rounded-lg hover:bg-white/50 focus:outline-none focus:ring-2 focus:ring-purple-500 btn-modern group">
                                ...
                                <div class="hidden lg:block text-left">
                                    <p class="text-sm font-bold text-gray-900">{{ auth()->user()->name ?? 'Reviewer' }}</p>
                                    <p class="text-xs text-gray-500 font-medium">Reviewer</p>
                                </div>
