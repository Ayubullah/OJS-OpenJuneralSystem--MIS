            ...
            <div class="flex flex-col md:flex-row items-center md:items-end gap-8">
                ...
                <div class="relative group">
                    ...
                    <div class="absolute inset-0 bg-black/50 rounded-2xl opacity-0 group-hover:opacity-100 transition-all duration-300 flex items-center justify-center backdrop-blur-sm">
                        <form action="{{ route('editor.profile.image.update') }}" method="POST" enctype="multipart/form-data" id="imageForm">
                            @csrf
                            @method('PATCH')
                    ...
                    <!-- Remove Image Button -->
                    @if($user->profile_image)
                    <form action="{{ route('editor.profile.image.remove') }}" method="POST" class="absolute -top-2 -right-2">
                        @csrf
                        @method('DELETE')
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div class="lg:col-span-2 space-y-8">
            ...
            <div class="bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden">
                ...
                <form action="{{ route('editor.profile.update') }}" method="POST" class="p-6">
                    @csrf
                    @method('PATCH')
        ...
        <div class="space-y-8">
            ...
            <div class="bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden">
                ...
                <form action="{{ route('editor.profile.password.update') }}" method="POST" class="p-6 space-y-5">
                    @csrf
                    @method('PUT')
