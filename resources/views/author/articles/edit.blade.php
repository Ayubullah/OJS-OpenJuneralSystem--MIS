...
@section('page-description', __('Update your article submission details'))
...
<div class="py-6">
    <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-8">
            ...
            <p class="mt-2 text-gray-600">{{ __('Update the details of your article submission') }}</p>
        </div>
        ...
        <div class="bg-white rounded-xl shadow-lg border border-gray-100 overflow-hidden">
            <div class="px-6 py-4 border-b border-gray-100 bg-gradient-to-r from-green-50 to-teal-50">
                <div class="flex items-center">
                    ...
                    <div>
                        <h2 class="text-xl font-bold text-gray-900">{{ __('Edit Article Form') }}</h2>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="md:col-span-2">
                            ...
                            <select name="manuscript_type" id="manuscript_type" 
                                ...
                                <option value="Research Article" {{ old('manuscript_type', $article->manuscript_type) == 'Research Article' ? 'selected' : '' }}>{{ __('Research Article') }}</option>
                                <option value="Review Article" {{ old('manuscript_type', $article->manuscript_type) == 'Review Article' ? 'selected' : '' }}>{{ __('Review Article') }}</option>
                                <option value="Case Study" {{ old('manuscript_type', $article->manuscript_type) == 'Case Study' ? 'selected' : '' }}>{{ __('Case Study') }}</option>
                                <option value="Short Communication" {{ old('manuscript_type', $article->manuscript_type) == 'Short Communication' ? 'selected' : '' }}>{{ __('Short Communication') }}</option>
                                <option value="Letter to Editor" {{ old('manuscript_type', $article->manuscript_type) == 'Letter to Editor' ? 'selected' : '' }}>{{ __('Letter to Editor') }}</option>
                            </select>
                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <textarea name="abstract" id="abstract" rows="6" 
                                ...
                                placeholder="{{ __('Enter the abstract of your article...') }}" required>{{ old('abstract', $article->abstract) }}</textarea>
                            @error('abstract')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
