...
<li class="flex items-center">
    ...
    <a href="{{ route('author.articles.index') }}" class="ml-2 text-sm font-medium text-gray-500 hover:text-gray-700">My Articles</a>
</li>
<li class="flex items-center">
...
<div class="max-w-6xl mx-auto space-y-8">
    ...
    <!-- Success Message -->
    @if(session('success'))
    <div class="bg-gradient-to-r from-green-50 to-emerald-50 border border-green-200 rounded-2xl p-4 shadow-sm animate-fade-in">
        <div class="flex items-center">
            ...
            <div>
                ...
                <p class="text-xs text-green-600 mt-0.5">Your changes have been saved</p>
            </div>
        </div>
    </div>
    @endif
    ...
    <!-- Profile Header Card -->
    <div class="relative overflow-hidden bg-gradient-to-br from-emerald-600 via-teal-600 to-cyan-700 rounded-3xl shadow-2xl">
        <!-- Background Pattern -->
            ...
            <div class="flex flex-col md:flex-row items-center md:items-end gap-8">
                ...
                <div class="relative group">
                    ...
                    <div class="absolute inset-0 bg-black/50 rounded-2xl opacity-0 group-hover:opacity-100 transition-all duration-300 flex items-center justify-center backdrop-blur-sm">
                        <form action="{{ route('author.profile.image.update') }}" method="POST" enctype="multipart/form-data" id="imageForm">
                            @csrf
                            @method('PATCH')
                    ...
                    <!-- Remove Image Button -->
                    @if($user->profile_image)
                    <form action="{{ route('author.profile.image.remove') }}" method="POST" class="absolute -top-2 -right-2">
                        @csrf
                        @method('DELETE')
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div class="lg:col-span-2 space-y-8">
            ...
            <div class="bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden">
                ...
                <form action="{{ route('author.profile.update') }}" method="POST" class="p-6">
                    @csrf
                    @method('PATCH')
                        ...
                        <div class="space-y-2">
                            ...
                            <div class="relative">
                                ...
                                <input type="text" id="name" name="name" value="{{ old('name', $user->name) }}" required
                                       class="w-full pl-12 pr-4 py-3 bg-gray-50 border border-gray-200 rounded-xl text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-transparent focus:bg-white transition-all duration-200 @error('name') border-red-500 @enderror">
                            </div>
                            @error('name')
                        ...
                        <div class="space-y-2">
                            ...
                            <div class="relative">
                                ...
                                <input type="text" id="username" name="username" value="{{ old('username', $user->username) }}" required
                                       class="w-full pl-12 pr-4 py-3 bg-gray-50 border border-gray-200 rounded-xl text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-transparent focus:bg-white transition-all duration-200 @error('username') border-red-500 @enderror">
                            </div>
                            @error('username')
                                <p class="text-sm text-red-500 flex items-center"><i data-lucide="alert-circle" class="w-4 h-4 mr-1"></i>{{ $message }}</p>
                            @enderror
                        ...
                        <div class="space-y-2">
                            ...
                            <div class="relative">
                                ...
                                <input type="email" id="email" name="email" value="{{ old('email', $user->email) }}" required
                                       class="w-full pl-12 pr-4 py-3 bg-gray-50 border border-gray-200 rounded-xl text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-transparent focus:bg-white transition-all duration-200 @error('email') border-red-500 @enderror">
                            </div>
                            @error('email')
                                <p class="text-sm text-red-500 flex items-center"><i data-lucide="alert-circle" class="w-4 h-4 mr-1"></i>{{ $message }}</p>
                            @enderror
                        ...
                        <div class="space-y-2">
                            ...
                            <div class="relative">
                                ...
                                <input type="tel" id="phone" name="phone" value="{{ old('phone', $user->phone) }}"
                                       ...
                                       class="w-full pl-12 pr-4 py-3 bg-gray-50 border border-gray-200 rounded-xl text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-transparent focus:bg-white transition-all duration-200 @error('phone') border-red-500 @enderror">
                            </div>
                            @error('phone')
                                <p class="text-sm text-red-500 flex items-center"><i data-lucide="alert-circle" class="w-4 h-4 mr-1"></i>{{ $message }}</p>
                            @enderror
                        ...
                        <div class="md:col-span-2 space-y-2">
                            ...
                            <div class="relative">
                                <textarea id="bio" name="bio" rows="4" 
                                          ...
                                          class="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-transparent focus:bg-white transition-all duration-200 resize-none @error('bio') border-red-500 @enderror">{{ old('bio', $user->bio) }}</textarea>
                            </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                            ...
                            <div class="md:col-span-3 space-y-2">
                                ...
                                <input type="text" id="address" name="address" value="{{ old('address', $user->address) }}"
                                       ...
                                       class="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-transparent focus:bg-white transition-all duration-200">
                            </div>
                    ...
                    <div class="mt-8 flex justify-end">
                        <button type="submit" class="inline-flex items-center px-6 py-3 bg-gradient-to-r from-emerald-600 to-teal-600 text-white font-semibold rounded-xl hover:from-emerald-700 hover:to-teal-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-emerald-500 transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl">
        ...
        <div class="space-y-8">
            ...
            <div class="bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden">
                ...
                <form action="{{ route('author.profile.password.update') }}" method="POST" class="p-6 space-y-5">
                    @csrf
                    @method('PUT')
            ...
            <div class="bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden">
                ...
                <div class="p-6 space-y-4">
                    ...
                    <div class="flex items-center justify-between py-3 border-b border-gray-100">
                        <div class="flex items-center">
                            <i data-lucide="pen-tool" class="w-5 h-5 text-gray-400 mr-3"></i>
                            <span class="text-sm text-gray-600">Role</span>
                        </div>
                        <span class="inline-flex items-center px-2.5 py-1 rounded-lg bg-emerald-100 text-emerald-800 text-xs font-semibold">
                            Author
                        </span>
                    </div>
