...
@section('page-description', 'Welcome to your OJS admin dashboard')
...
<div class="space-y-6">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <div class="bg-white rounded-xl shadow-lg border border-gray-100 p-6 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
            <div class="flex items-center justify-between">
                <div>
                    <p class="text-sm font-medium text-gray-600 mb-1">Total Journals</p>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div class="bg-white rounded-xl shadow-lg border border-gray-100 p-6">
            <div class="flex items-center justify-between mb-6">
                <h3 class="text-lg font-bold text-gray-900">Articles by Status</h3>
                <div class="flex items-center space-x-2">
                    <div class="w-3 h-3 bg-blue-500 rounded-full"></div>
                    <span class="text-sm text-gray-600">Status Distribution</span>
                </div>
            </div>
            <div class="space-y-4">
            ...
            <div class="space-y-4">
                ...
                <div class="flex items-center space-x-4 p-3 rounded-lg hover:bg-gray-50 transition-colors duration-200">
                    ...
                    <div class="flex-1 min-w-0">
                        <p class="text-sm font-medium text-gray-900 truncate">{{ $submission->article->title ?? 'Untitled' }}</p>
                        <p class="text-xs text-gray-500">{{ $submission->author->name ?? 'Unknown Author' }}</p>
                    </div>
                    <div class="flex items-center space-x-2">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="lg:col-span-2 bg-white rounded-xl shadow-lg border border-gray-100 p-6">
            <div class="flex items-center justify-between mb-6">
                <h3 class="text-lg font-bold text-gray-900">Top Journals</h3>
                <a href="{{ route('admin.journals.index') }}" class="text-sm text-blue-600 hover:text-blue-700 font-medium">View all</a>
            </div>
            <div class="space-y-4">
                ...
                <div class="text-center py-8">
                    ...
                    <p class="text-gray-500 text-sm">No journals found</p>
                </div>
                @endforelse
            </div>
        </div>
        ...
        <div class="bg-white rounded-xl shadow-lg border border-gray-100 p-6">
            ...
            <div class="space-y-3">
                <a href="{{ route('admin.journals.create') }}" class="flex items-center space-x-3 p-3 rounded-lg hover:bg-blue-50 hover:border-blue-200 border border-gray-100 transition-all duration-200 group">
                    ...
                    <span class="text-sm font-medium text-gray-700 group-hover:text-blue-700">Add New Journal</span>
                </a>
                ...
                <a href="{{ route('admin.articles.create') }}" class="flex items-center space-x-3 p-3 rounded-lg hover:bg-green-50 hover:border-green-200 border border-gray-100 transition-all duration-200 group">
                    ...
                    <span class="text-sm font-medium text-gray-700 group-hover:text-green-700">Add New Article</span>
                </a>
                ...
                <a href="{{ route('admin.users.create') }}" class="flex items-center space-x-3 p-3 rounded-lg hover:bg-purple-50 hover:border-purple-200 border border-gray-100 transition-all duration-200 group">
                    ...
                    <span class="text-sm font-medium text-gray-700 group-hover:text-purple-700">Add New User</span>
                </a>
                ...
                <a href="{{ route('admin.submissions.index') }}" class="flex items-center space-x-3 p-3 rounded-lg hover:bg-orange-50 hover:border-orange-200 border border-gray-100 transition-all duration-200 group">
                    ...
                    <span class="text-sm font-medium text-gray-700 group-hover:text-orange-700">Review Submissions</span>
                </a>
            </div>
        </div>
    </div>
