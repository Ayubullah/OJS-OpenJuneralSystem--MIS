...
@section('page-description', 'Update article information')
        ...
        <div class="px-8 py-6 border-b border-gray-100 bg-gradient-to-r from-purple-50 to-blue-50">
            <div class="flex items-center">
                ...
                <div>
                    ...
                    <p class="text-sm text-gray-600">Update article information</p>
                </div>
            </div>
        </div>
                ...
                <div class="space-y-2">
                    ...
                    <div class="relative">
                        <select id="status" 
                            ...
                            <option value="under_review" {{ old('status', $article->status) === 'under_review' ? 'selected' : '' }}>Under Review</option>
                            <option value="revision_required" {{ old('status', $article->status) === 'revision_required' ? 'selected' : '' }}>Revision Required</option>
                            <option value="accepted" {{ old('status', $article->status) === 'accepted' ? 'selected' : '' }}>Accepted</option>
