...
@section('page-description', 'Update author information')
    ...
    <div class="bg-white rounded-xl shadow-lg border border-gray-100 overflow-hidden">
        ...
        <div class="px-6 py-4 border-b border-gray-100 bg-gradient-to-r from-blue-50 to-cyan-50">
            <div class="flex items-center">
                ...
                <div>
                    <h2 class="text-xl font-bold text-gray-900">Edit Author</h2>
                    <p class="text-sm text-gray-600">Update the author information below</p>
                </div>
            </div>
        </div>
        ...
        <form action="{{ route('admin.authors.update', $author) }}" method="POST" class="p-6 space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="text" name="affiliation" id="affiliation" value="{{ old('affiliation', $author->affiliation) }}" 
                ...
                <div>
                    ...
                    <input type="text" name="specialization" id="specialization" value="{{ old('specialization', $author->specialization) }}" 
                ...
                <div class="md:col-span-2">
                    ...
                    <div class="flex items-center">
                        ...
                        <input type="text" name="orcid_id" id="orcid_id" value="{{ old('orcid_id', $author->orcid_id) }}" 
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea name="author_contributions" id="author_contributions" rows="4" 
                        ...
                        placeholder="Describe the author's specific contributions to research...">{{ old('author_contributions', $author->author_contributions) }}</textarea>
