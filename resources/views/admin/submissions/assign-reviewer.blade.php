...
<div class="max-w-3xl mx-auto">
    ...
    <div class="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden">
        ...
        <form action="{{ route('admin.submissions.assign-reviewer.store', $submission) }}" method="POST" class="p-8 space-y-8" @if($submission->article->status === 'rejected' || $submission->status === 'rejected') onsubmit="event.preventDefault(); alert('Cannot assign reviewers to a rejected article.'); return false;" @endif>
            @csrf
